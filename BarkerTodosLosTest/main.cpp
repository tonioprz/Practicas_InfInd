...
int main()
{
    ...
    while(1){
        switch(estado){
            ...
            string archivo;
            cout << endl << "Por favor, introduzca el archivo que desea cargar" << endl;
            cin >> archivo;
            if(manager.loadFromFile(archivo)){
        ...
        case 6:{ //Guardar archivo usuarios
            string archivo;
            cout << endl << "Por favor, introduzca el archivo donde quiere descargar los datos." << endl;
            cin >> archivo;
            if(manager.saveToFile(archivo)){
                cout << "Archivo descargado con exito." << endl;
                }
                else {
                cout << "El archivo no se pudo descargar." << endl;
                }
            estado = 0;
            }
                    break;
            ...
            cin.getline(bark, 128);
            cin.getline(bark, 128);
            string texto = bark;
            if(manager.createBark(texto)){
            ...
            cin.getline(rebark,128);
            cin.getline(rebark,128);
            string texto = rebark;
            if(manager.createRebark(referencia, texto)){
